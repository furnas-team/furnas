...
export class SaraghPortfolioPage extends React.Component {
  ...
  render() {
    return (
      <AbstractPortfolioPage code={PortfolioCode.SARAGH}>
        <div className="saragh-portfolio" ref={this.props.refProp}>
          ...
          <PortfolioContainer className="saragh-portfolio__design-container">
            <div className="saragh-portfolio__design-text-block">
              ...
              <PortfolioText>
                <p>Продукт имеет сложную структуру и для облегчения восприятия данных осоновным цветом берём белый цвет. Данные не тесним, а с помощью пустых мест добавляем свободы. Дополнительные
                  цвета яркие и бодрящие: бирюзовый и тепло-жёлтый.</p>
              </PortfolioText>
            </div>
