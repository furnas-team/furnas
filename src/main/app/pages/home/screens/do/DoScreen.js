...
const ACCORDION_ITEMS = [
  {title: 'Сайты', text: 'Делаем сайты любой сложности: начиная от элементарных лендингов на тильде, заканчиваю сложными корпоративными порталами', img: [require('./images/do.svg')]},
  {title: 'Дизайн', text: 'Делаем дизайн для всего чего возможно: сайтов, мобильных приложений, рекламных баннеров и даже открыток', img: [require('./images/do.svg')]},
  {title: 'Разработка', text: 'Поможем с разработкой всего на свете: решим сложную алгоритмическую задачу, поможем с интеграцией чего угодно и куда угодно.', img: [require('./images/do.svg')]},
  {title: 'Startup', text: 'Если у вас есть крутая идея - поможем проверить ее и запуститься максимально быстро', img: [require('./images/do.svg')]},
];
