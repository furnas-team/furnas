...
const ACCORDION_ITEMS = [
  ...
  {title: 'Разработка', text: 'Поможем с разрбаткой всего на свете: решим сложную алгоритмическую задачу, поможем с интеграцией чего угодно и куда угодно.', img: [require('./images/do.svg')]},
